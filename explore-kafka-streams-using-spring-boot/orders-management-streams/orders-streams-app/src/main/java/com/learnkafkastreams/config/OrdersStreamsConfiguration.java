...
public class OrdersStreamsConfiguration {
    ...
    public KafkaStreamsConfiguration kStreamConfig() throws UnknownHostException {
        ...
        //set the address of this particular instance
        streamProperties.put(StreamsConfig.APPLICATION_SERVER_CONFIG, InetAddress.getLocalHost().getHostAddress()+":"+port);//fetches the IP of the host
